...
public class RouterController {
    ...
    @PostMapping("/toLogin")
    public String login(@RequestParam("number") Integer number, @RequestParam("password") String password,
        ...
        if (user == null){
          ...
          /*  Integer userid = (int)session.getAttribute("userid");
            ...
            if (String.valueOf(user.getRole()).equals("ADMIN")) {
                ...
                List<Coupon> allCoupon = cs.findAll();
    ...
    public String toRegister(String registerUsername,Integer registerNumber, String registerPassword,Model m) {
    ...
    public String toAdminPage(Model m , HttpSession session) {
        ...
        if (us.findUserById(userid).getRole().equals(User.Role.ADMIN))
            return "adminIndex";
        return "login";
    }
    @GetMapping("/register")
